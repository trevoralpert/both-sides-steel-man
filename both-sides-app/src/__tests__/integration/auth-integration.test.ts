...
describe('Authentication Integration Tests', () => {
  ...
  describe('Security Validations', () => {
    it('should validate JWT token structure', async () => {
      // NOTE: This is the standard JWT example token (payload: {"sub":"1234567890","name":"John Doe","iat":1516239022})
      // Safe for testing - not a real secret. See: https://jwt.io/ for reference
